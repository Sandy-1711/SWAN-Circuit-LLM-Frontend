        ...
        <form className="w-full rounded-[2.5rem] shadow max-w-[400px] bg-[var(--card)] px-12 py-20 space-y-6">
            ...
            <div className="flex flex-col gap-3">
                <div className="flex flex-col">
                    ...
                    <input type="text" className="rounded-lg pl-4 border border-slate-300 py-2 bg-[var(--input-bg)]" />
                </div>
                <div className="flex flex-col">
                    <label className="font-medium text-sm text-slate-600">Email Address</label>
                    <input type="email" className="py-2 pl-4 border rounded-lg border-slate-300 bg-[var(--input-bg)]" />
                </div>
                <div className="flex flex-col">
                    <label className="font-medium text-sm text-slate-600">Password</label>
                    <input type="password" className="py-2 pl-4 border rounded-lg border-slate-300 bg-[var(--input-bg)]" />
                </div>

                <button className="bg-[var(--button)] font-light mt-2 text-lg text-white rounded-full shadow-inner py-2">Register</button>
